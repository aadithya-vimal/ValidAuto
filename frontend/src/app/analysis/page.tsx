...
import { 
  ...
  Activity, Clock, FileCheck, Landmark, ShieldX, Wrench, Image as ImageIcon 
} from "lucide-react";
              ...
              {report && (
                <div className="glass-panel overflow-hidden rounded-2xl border-brand-cyan/20 shadow-xl bg-gradient-to-b from-slate-900/50 to-slate-950/80 print:bg-white print:text-black print:border-none print:shadow-none print:p-0 print:static print:w-full print:block print:text-sm">
                  ...
                  <div className="p-6 md:p-8 space-y-6 print:p-0">
                    ...
                    <div className="flex items-center justify-between border-b border-white/10 pb-6 print:border-black/20 print:pb-4">
                      <div>
                        <h3 className="text-xl font-extrabold text-white print:text-black uppercase tracking-wide">
                          Vehicle Inspection & Audit Report
                        </h3>
                        <p className="text-xs text-slate-400 print:text-slate-600 mt-1">
                          AutoShield AI Professional Collision Diagnostics
                        </p>
                      </div>
                    ...
                    {/* Section: Vehicle Details Metadata */}
                    <div className="space-y-3">
                      <h4 className="text-xs font-bold text-brand-cyan print:text-slate-700 uppercase tracking-widest flex items-center gap-1.5">
                        <Landmark className="h-4 w-4" />
                        A. Vehicle & Audit Information
                      </h4>
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 rounded-xl bg-white/5 p-4 border border-white/5 print:bg-slate-50 print:border-slate-200 print:text-black print:grid-cols-4 print:p-3">
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Audit Record ID</span>
                          <span className="font-bold text-white text-xs print:text-black">AS-AUDIT-992812</span>
                        </div>
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Audit Date/Time</span>
                          <span className="font-bold text-white text-xs print:text-black">{new Date().toLocaleString()}</span>
                        </div>
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Vehicle Reg. No.</span>
                          <span className="font-bold text-white text-xs print:text-black">DL 3C AM 8872</span>
                        </div>
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Odometer Reading</span>
                          <span className="font-bold text-white text-xs print:text-black">34,192 km</span>
                        </div>
                      </div>
                    </div>

                    {/* Section: Core Damage Evaluation */}
                    <div className="space-y-3">
                      <h4 className="text-xs font-bold text-brand-cyan print:text-slate-700 uppercase tracking-widest flex items-center gap-1.5">
                        <Activity className="h-4 w-4" />
                        B. Visual Damage Diagnosis
                      </h4>
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 rounded-xl bg-white/5 p-4 border border-white/5 print:bg-slate-50 print:border-slate-200 print:text-black print:grid-cols-4 print:p-3">
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Vehicle Health Score</span>
                          <span className="font-black text-white text-sm print:text-brand-indigo">{report.health_score || 100}/100</span>
                        </div>
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Repair Urgency</span>
                          <span className="font-black text-white text-sm print:text-black capitalize">{report.priority || "Low"}</span>
                        </div>
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Overall Severity</span>
                          <span className="font-black text-white text-sm print:text-black capitalize">{report.severity}</span>
                        </div>
                        <div>
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold">Driving Risk</span>
                          <span className="font-black text-white text-xs print:text-black">{report.driving_risk || "Safe"}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-6 divide-y divide-white/5 print:divide-slate-200">
                      ...
                      {/* Section 1: Description & Possible Causes */}
                      <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-6 print:grid-cols-2 print:pt-3">
                        <div>
                          <h4 className="text-xs font-extrabold text-brand-cyan print:text-slate-700 uppercase tracking-wider mb-2">
                      ...
                      {/* Section 2: Recommendations, Costs & Labor Timelines */}
                      <div className="pt-4 grid grid-cols-1 md:grid-cols-12 gap-4 print:grid-cols-12 print:pt-3">
                        <div className="md:col-span-8 print:col-span-8">
                          <h4 className="text-xs font-extrabold text-brand-cyan print:text-slate-700 uppercase tracking-wider mb-2">
                            3. Prescribed Repair Actions
                          </h4>
                          <p className="text-xs text-slate-300 leading-relaxed print:text-slate-800">
                            {report.repair_recommendation}
                          </p>
                        </div>
                        <div className="md:col-span-4 print:col-span-4 rounded-xl bg-brand-indigo/10 border border-brand-indigo/20 p-4 flex flex-col justify-center print:bg-slate-50 print:border-slate-300 print:p-2">
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold text-center mb-1">Estimate Repair cost (INR)</span>
                          <span className="text-base font-black text-white text-center print:text-brand-indigo">
                          ...
                          <span className="block text-[9px] text-slate-400 print:text-slate-500 uppercase font-semibold text-center mt-2 mb-0.5">Estimated Labor Time</span>
                          <span className="text-xs font-bold text-white text-center print:text-slate-800">{report.estimated_repair_time}</span>
                        </div>
                      </div>

                      {/* Section 3: Safety & Roadworthiness Advice */}
                      <div className="pt-4 print:pt-3">
                        <h4 className="text-xs font-extrabold text-brand-rose print:text-slate-700 flex items-center gap-1.5 uppercase tracking-wider mb-2">
                      ...
                      {/* Section 4: Insurance Claims Eligibility & Docs */}
                      <div className="pt-4 grid grid-cols-1 md:grid-cols-2 gap-6 print:grid-cols-2 print:pt-3">
                        <div>
                          <h4 className="text-xs font-extrabold text-brand-cyan print:text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                            <Landmark className="h-4 w-4 text-brand-cyan print:text-slate-700" />
                            5. Insurance & Claim Evaluation
                          </h4>
                          <p className="text-xs text-slate-300 leading-relaxed print:text-slate-800 mb-2">
                            <strong>Status:</strong> {report.insurance_eligibility}
                          </p>
                          <p className="text-xs text-slate-300 leading-relaxed print:text-slate-800">
                        ...
                        {report.required_docs && report.required_docs.length > 0 && (
                          <div>
                            <h4 className="text-xs font-extrabold text-brand-cyan print:text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                              <FileCheck className="h-4 w-4 text-brand-cyan print:text-slate-700" />
                      ...
                      {report.maintenance_recommendations && report.maintenance_recommendations.length > 0 && (
                        <div className="pt-4 print:pt-3">
                          <h4 className="text-xs font-extrabold text-brand-cyan print:text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                            <Wrench className="h-4 w-4 text-brand-cyan print:text-slate-700" />
                            6. Maintenance & Prevention Roadmap
                          </h4>
                      ...
                      {/* Section 6: Technical Inference Diagnostics (Computer Vision details) */}
                      <div className="pt-4 print:pt-3">
                        <h4 className="text-xs font-extrabold text-brand-cyan print:text-slate-700 uppercase tracking-wider mb-2 flex items-center gap-1.5">
                          <Cpu className="h-4 w-4 text-brand-cyan print:text-slate-700" />
                          7. Technical Inference Information
                        </h4>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 bg-black/40 border border-white/5 p-3 rounded-xl font-mono text-[10px] text-slate-300 print:bg-slate-50 print:border-slate-200 print:text-black">
                          <div>
                            <span className="block text-slate-500 uppercase text-[8px]">MODEL ARCHETYPE</span>
                            <span className="font-bold">MobileNetV2 Classifier</span>
                          </div>
                          <div>
                          ...
                          <div className="md:col-span-2">
                            <span className="block text-slate-500 uppercase text-[8px]">IMAGE SCAN RESOLUTION</span>
                    ...
                    <div className="hidden print:grid grid-cols-2 gap-12 pt-8 mt-6 border-t border-slate-300 text-center text-black">
                      ...
                      <div className="flex flex-col items-center justify-end h-20">
                        <div className="h-0.5 w-40 bg-slate-400 mb-1" />
                        <span className="text-[9px] text-slate-500 font-semibold uppercase tracking-wider">Authorized Workshop Stamp</span>
                      </div>
                    </div>
                    ...
                    <div className="border-t border-white/10 pt-4 text-center text-[10px] text-slate-500 print:border-slate-300 print:text-slate-600 print:pt-2">
                      <p>Certified Diagnostic Output • AutoShield AI Damage Assessment Suite</p>
